!function(a) {
    ...
    a(document).on("click", "[data-gallery]", function(c) {
        var d = a(this).data("gallery"), e = a(d), f = e.length && e || a(b.prototype.options.container), g = {onopen: function() {
                f.data("gallery", this).trigger("open", this)
            },onopened: function() {
                f.trigger("opened", this)
            },onslide: function() {
                f.trigger("slide", [].slice.call(arguments).concat(this))
            },onslideend: function() {
                f.trigger("slideend", [].slice.call(arguments).concat(this))
            },onslidecomplete: function() {
                f.trigger("slidecomplete", [].slice.call(arguments).concat(this))
            },onclose: function() {
                f.trigger("close", this)
            },onclosed: function() {
                f.trigger("closed", this).removeData("gallery")
